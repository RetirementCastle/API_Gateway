"main";let ApolloServer,gql;_583‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI,EmployeeAPI,NursingHomesAPI;_583‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}],["EmployeeAPI",["EmployeeAPI"],function(v){EmployeeAPI=v}],["NursingHomesAPI",["NursingHomesAPI"],function(v){NursingHomesAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
    _583‍.g.console.log(`🚀 Server ready at ${url}`);
    _583‍.g.console.log('${node_be}');
});
