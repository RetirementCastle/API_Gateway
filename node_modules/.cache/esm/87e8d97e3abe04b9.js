"main";let ApolloServer,gql;_3ab‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI,EmployeeAPI,NursingHomesAPI;_3ab‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}],["EmployeeAPI",["EmployeeAPI"],function(v){EmployeeAPI=v}],["NursingHomesAPI",["NursingHomesAPI"],function(v){NursingHomesAPI=v}]]);
...
server.listen().then(({ url }) => {
    _3ab‍.g.console.log(`🚀 Server ready at ${url}`);
    _3ab‍.g.console.log('${node_be}');
});
