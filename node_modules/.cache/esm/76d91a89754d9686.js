"main";_754‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI],["EmployeeAPI",()=>EmployeeAPI],["NursingHomesAPI",()=>NursingHomesAPI]]);let RESTDataSource;_754‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
...
const axios = require('axios')
    ...
    checkToken(correo, token){
        ...
        if(token=="sasa"){
            ...
            return new Promise(function(resolve,reject) {
                ...
                .then((res) => {
                    _754‍.g.console.log(res.data);
                    _754‍.g.console.log(res.data);
                    resolve(res.data.response.status);
                })
                .catch((error) => {
                    _754‍.g.console.error(error)
                })
            })
        }
    }
    ...
    async createAResident(args) {
        if(await this.checkToken(args.correo, args.token)=='true'){
            ...
            _754‍.g.console.log("NursingHomesAPI");

            var object = await axios.get(args.branchURL+'branches/'+args.branchID);

            new Promise(function(resolve,reject) {
                _754‍.g.console.log(object);
                _754‍.g.console.log(object.data.available_rooms);
    ...
    async editAResident(args) {
        _754‍.g.console.log(this.checkToken(args.token));
        if(await this.checkToken(args.correo, args.token)=='true'){
    ...
    async createAnUser(args) {
        args.baseURL = "http://ms-users-rails-kevinandrey96.c9users.io/"
        return new Promise(function(resolve,reject) {
    ...
    async deleteAnEmployee(correo, token, idNumber) {
       ...
       class NursingHomesAPI extends RESTDataSource {
    constructor() {
        super();
    ...
    async getNursinghomesBranches(idnursinghome) {
        ...
        _754‍.g.console.log('nursinghome/'+idnursinghome+'/branches');
